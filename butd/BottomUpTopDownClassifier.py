...
class BottomUpTopDownClassifier(pl.LightningModule):
    def __init__(self, pretrained_emb, answer_size, GRID_FEAT_SIZE=None, FRCN_FEAT_SIZE=None, BBOX_FEAT_SIZE=None,
        ...
        super(BottomUpTopDownClassifier, self).__init__()
        ...
        if not configs_filename:
            configs_filename = 'butd/configs.yml'
    ...
    def forward(self, questions=None, spatial_features=None, visual_features=None,
        ...
        if self.configs.USE_IMAGE_FEATURE_EXTRACTOR:
            img_feat = self.cnn(spatial_features)
        elif utils.is_tensor_list_nonempty(spatial_features):
